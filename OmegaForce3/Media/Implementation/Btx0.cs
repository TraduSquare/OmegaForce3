...
namespace Ninoimager.Format
{
	public class Btx0
	{
		...
		public Bitmap CreateBitmap(int texIdx)
        {
			return this.CreateBitmap(texIdx, this.SearchPaletteIdx(texIdx));
        }

		public Bitmap CreateBitmap(int texIdx, int palIdx)
		{
			// Get palette
		...
		public Bitmap CreateBitmap(int texIdx, Palette palette)
		{
			// Get image
			Bitmap img = this.images[texIdx].CreateBitmap(palette, 0);
